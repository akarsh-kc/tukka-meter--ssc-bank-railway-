...
![PC View](pc2.png)
![PC View](pc4.png)
🔒 **Your data stays on your own device by default.** No login, no account, no data collection, nothing uploaded anywhere — unless you *choose* to turn on Google Drive backup, in which case your data goes only to your own personal Google Drive (never to me or anyone else).
...
- The app may ask for two permissions, both fully optional and never automatic: importing a JSON backup file, or signing into your own Google account if you turn on Drive sync.
![PC View](pc3.png)
...
- Track accuracy, attempts, guesses, and improvement trends
...
- Your data lives only on your own browser/phone
- The only time this app connects to the internet is if you turn on Google Drive sync — off by default, entirely your choice, and your data goes straight to your own Drive account, not through any server of mine
## How to use
1. **Choose your exam track (SSC, Railway, or Bank).**
...
---
## ⚠️ Disclaimer
This project is provided for personal and educational use only. It is not intended for commercial purposes.
If you are using a modified or unofficial version of this project, I am not responsible for any issues, errors, data loss, security risks, or damages that may result from it.
License: CC BY-NC-SA 4.0
🚫 Do not sell, monetize, or redistribute this project or any modified version of it as a paid product.
[![License: CC BY-NC-SA 4.0](https://img.shields.io/badge/License-CC_BY--NC--SA_4.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc-sa/4.0/)
---
Built by an aspirant, for aspirants. Free to use — share it with anyone preparing for **SSC, Railway, or Bank** exams.
